...
const TerminalConsole = () => {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("toggle-terminal-drawer", handleToggle);
  }, []);
  ...
  const handleCommandSubmit = (e) => {
    ...
    const newHistory = [
      ...history,
      { text: `visitor@shalimar:~$ ${input}`, type: "input" },
    ];
    ...
    if (cmdLower === "help") {
      newHistory.push(
        ...
        {
          text: "  about    - Print background and career philosophy",
          type: "output",
        },
        {
          text: "  skills   - List core technologies and frameworks",
          type: "output",
        },
        { text: "  projects - List selected projects", type: "output" },
        {
          text: "  theme    - Switch accent theme (e.g. theme sage, theme violet, theme crimson)",
          type: "output",
        },
        {
          text: "  matrix   - Toggle the secret Matrix code rain animation",
          type: "output",
        },
        {
          text: "  coffee   - Dispense a random developer quote",
          type: "output",
        },
      ...
      newHistory.push(
        ...
        {
          text: "Education: BCA from IGNOU & Master Diploma in Computer Eng.",
          type: "output",
        },
        {
          text: "Philosophy: Bridging frontend aesthetics with optimized server logic.",
          type: "output",
        },
        {
          text: "Business: Founder of Dev Dossier, delivering high-speed web services.",
          type: "output",
        },
      );
      ...
      newHistory.push(
        {
          text: "Frontend: HTML, CSS, JavaScript, React, Next.js, Tailwind, Figma",
          type: "output",
        },
        {
          text: "Backend: Node.js, Express.js, MySQL, PostgreSQL, MongoDB, REST APIs",
          type: "output",
        },
        {
          text: "Tools: Git, GitHub, WordPress, Elementor, Linux, VS Code",
          type: "output",
        },
      );
      ...
      newHistory.push(
        {
          text: "1. Dev Dossier Business Web App (Next.js & Tailwind)",
          type: "output",
        },
        {
          text: "2. Personal Developer Portfolio (Next.js & Tailwind)",
          type: "output",
        },
        {
          text: "3. 24/7 Delivery Experts Logistics (WordPress & Elementor Pro)",
          type: "output",
        },
        {
          text: "4. The Lamen - News Media Hub (WordPress & Elementor)",
          type: "output",
        },
        {
          text: "5. VibeSync Social Networking (PHP, JS, MySQL)",
          type: "output",
        },
        {
          text: "Type the name in search or click navbar to view details.",
          type: "output",
        },
      );
      ...
      if (themeId) {
        ...
        if (found) {
          ...
          window.dispatchEvent(
            new CustomEvent("portfolio-theme-change", { detail: found }),
          );
          newHistory.push({
            text: `Accent color theme changed to: ${found.name}`,
            type: "output",
          });
        } else {
          newHistory.push({
            text: `Error: Invalid theme. Select 'crimson', 'sage', 'indigo', 'ochre', or 'violet'.`,
            type: "error",
          });
        }
      } else {
        newHistory.push({
          text: "Current available themes: crimson, sage, indigo, ochre, violet.",
          type: "output",
        });
      }
      ...
      newHistory.push({
        text: matrixMode
          ? "Matrix digital rain disabled."
          : "Matrix digital rain activated. Follow the white rabbit...",
        type: "output",
      });
      ...
      newHistory.push({
        text: `bash: ${input}: command not found. Type 'help' for options.`,
        type: "error",
      });
    }
        ...
        <div className="bg-[#0c0f15] h-14 border-b border-white/10 flex items-center justify-between px-6">
          <div className="flex items-center gap-2.5">
            <div className="flex gap-1.5">
              <span
                className="w-3 h-3 rounded-full bg-rose-500/80 cursor-pointer"
                onClick={() => setHistory([])}
                title="Clear"
              />
        ...
        <div className="flex-1 overflow-y-auto p-6 text-xs space-y-1.5 relative scrollbar-thin">
          ...
          <div className="relative z-10 space-y-1">
            ...
            <form
              ...
              className="flex items-center gap-2 pt-2 border-t border-white/5 mt-4"
            >
              <span className="text-sky-400 flex-shrink-0">
                <span className="hidden xs:inline">visitor@shalimar:</span>~$
              </span>
              <input
                type="text"
                value={input}
