          ...
          <div className="container mx-auto px-4 my-5">
            <div className="flex flex-row items-start p-2">
              ...
              <p className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
                ...
                <b>Master of Computer Applications (MCA)</b> with a specialization in
                Computing and Software Systems from <b>IGNOU (Indira Gandhi
                National Open University)</b>.
                <br />
                <br />
                Throughout my educational journey, I have undertaken various
                <b>courses and certifications</b> to continually enhance my skills in
                the <b>ever-evolving fields of technology and design</b>. My academic
                background has provided me with a strong foundation in <b>software
                engineering, web development, and UI/UX design, enabling me to
                develop a versatile skill set that bridges the gap between
                technical proficiency and creative innovation</b>.
              </p>
            </div>
            ...
            <div className="mt-[-15px] md:mt-[-38px]">
              <div className="flex flex-row items-start p-2">
                ...
                <p className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
                  ...
                  <br />
                  <br />I am deeply passionate about exploring <b>new trends and
                  innovations in the technology sector</b>. My curiosity drives me
            ...
            <div className="mt-[-15px] md:mt-[-38px]">
              <div className="flex flex-row items-start p-2">
                ...
                <p className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
                  ...
                  maintain an active and vibrant presence on my <b>YouTube
                  channels</b>.
                  <br />
                  <br />
