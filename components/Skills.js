...
const Skills = () => {
  return (
    <section id="skills" className="py-5">
      <span className="ml-5 font-Mitr xl:ml-24">.../Skills ...</span>
        ...
        <div className="flex flex-row items-start p-2">
          ...
          <p className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
            <i>
              ...
              development expertise, my skill set is designed to create dynamic,
              robust, and user-friendly web solutions. With proficiency in
              modern technologies and frameworks, I excel in building
              responsive, high-performance applications that meet diverse needs.
              I am deeply committed to continuous learning and staying abreast
              of the latest industry trends, ensuring that my work is always
              cutting-edge. By combining technical acumen with creative
              problem-solving, I bring innovative ideas to life, delivering
        ...
        <div className="flex flex-row items-start p-2">
          ...
          <div className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm ">
              ...
              <li>
                Responsive Design: Mastery in media queries and CSS frameworks
                like Bootstrap or Tailwind CSS.
              </li>
              <li>
                Performance Optimization: Efficient use of lazy loading, asset
                compression, and caching.
              </li>
              <li>
                UI/UX Design: Proficient in tools like Figma to create visually
                appealing, user-friendly interfaces.
              </li>
              <li>
                SEO: Implementation of on-page SEO techniques for better search
                engine rankings.
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-row items-start p-2">
          ...
          <div className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm ">
              ...
              <li>
                Authentication: Secure user authentication systems (OAuth, JWT).
              </li>
              <li>
      ...
      <div className="container mt-[-15px] md:mt-[-38px] mx-auto px-4">
        <div className="flex flex-row items-start p-2">
          ...
          <div className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm ">
              <li>
                Version Control: Mastery of Git and GitHub for version control
                and collaborative development.
              </li>
              <li>
                Build Tools: Skilled in using Webpack and Gulp for automation
                and optimization.
              </li>
              <li>
              ...
              <li>
                Content Management Systems (CMS): Proficient in WordPress for
                building and managing websites with dynamic content.
              </li>
              <li>
                ...
                <ul>
                  <li>
                    • Visual Studio Code: Expertise in this versatile, powerful
                    code editor.
                  </li>
                  <li>
                    • Sublime Text: Proficiency in using this lightweight and
                  ...
                  <li>
                    • PyCharm: Proficient in using this powerful IDE for Python
                    development.
                  </li>
                </ul>
              </li>
        ...
        <div className="flex flex-row items-start p-2">
          ...
          <div className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm ">
              ...
              <li>
                Team Collaboration: Work seamlessly with designers, developers,
                and stakeholders.
              </li>
              <li>
              ...
              <li>
                Time Management: Prioritize and manage multiple tasks to meet
                deadlines.
              </li>
              <li>
