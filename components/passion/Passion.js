...
const GamingShowcase = () => {
  ...
  const physicalGames = [
    ...
    },
    {
      ...
      genre: "Tactical Route Building",
      players: "2-5 Players",
      image:
        "https://images.unsplash.com/photo-1606500549045-36272b0aa4f6?auto=format&fit=crop&w=600&q=80",
    },
  ];
    ...
    <div className="w-full max-w-lg mx-auto bg-white border border-warm-gray-200 rounded-3xl p-6 shadow-md flex flex-col gap-6 text-left">
      ...
      <div className="grid grid-cols-2 gap-4">
        {games.map((game, idx) => (
          <div
            key={idx}
            className="group relative aspect-[4/3] rounded-2xl overflow-hidden border border-warm-gray-200 shadow-sm bg-warm-gray-50"
          >
            <Image
              src={game.image}
              alt={game.title}
  ...
  const photos = [
    {
      ...
      caption: "Mountain telemetries",
    },
    {
      src: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80",
      caption: "Scenic shorelines",
    },
    {
      src: "https://images.unsplash.com/photo-1472214222541-d510753a4707?auto=format&fit=crop&w=800&q=80",
      caption: "Lush valley fields",
    },
    {
      ...
      <div className="flex animate-marquee whitespace-nowrap gap-16 text-ink uppercase font-serif text-[11px] sm:text-xs tracking-[0.25em] font-extrabold">
        {[...row1Items, ...row1Items, ...row1Items].map((item, idx) => (
          <div key={`row1-${idx}`} className="flex items-center gap-16">
            <span>{item}</span>
            <span className="text-rose-500 text-sm sm:text-base animate-pulse">
              ✦
            </span>
          </div>
        ))}
...
const Passion = () => {
  return (
    <div className="relative pb-12 w-full overflow-hidden">
      ...
      >
        <div
          className="scroll-watermark passion-scroll-watermark absolute top-2 left-4 lg:top-4 lg:left-12 font-serif font-light text-[100px] sm:text-[140px] md:text-[180px] leading-none text-warm-gray-300 pointer-events-none select-none z-0"
          data-speed="-0.15"
        >
          01
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="flex-1 text-left">
              <span className="text-xs font-bold text-rose-600 uppercase tracking-[0.25em] mb-4 block">
                Creative Sandbox
              </span>
              ...
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-6 font-sans">
                Beyond my core client work and enterprise systems engineering, I
                believe in maintaining a creative sandbox. Sharing travel vlogs
                on YouTube, immersing myself in digital and physical gaming, and
                capturing cinematic travel landscapes helps me bring a fresh,
                creative perspective to everything I do.
              </p>
            ...
            <div className="flex-1 w-full grid grid-cols-2 gap-4">
              <div className="bg-white border border-warm-gray-200 rounded-3xl p-6 hover:border-rose-500 transition-colors group text-center shadow-sm">
                <h3 className="font-serif text-3xl font-black text-rose-500 mb-1 group-hover:scale-105 transition-transform duration-300">
                  18.6K+
                </h3>
                <p className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">
              ...
              <div className="bg-white border border-warm-gray-200 rounded-3xl p-6 hover:border-teal-500 transition-colors group text-center shadow-sm">
                <h3 className="font-serif text-3xl font-black text-teal-500 mb-1 group-hover:scale-105 transition-transform duration-300">
                  120+
                </h3>
                <p className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">
              ...
              <div className="bg-white border border-warm-gray-200 rounded-3xl p-6 hover:border-purple-500 transition-colors group text-center shadow-sm">
                <h3 className="font-serif text-3xl font-black text-purple-500 mb-1 group-hover:scale-105 transition-transform duration-300">
                  40+
                </h3>
                <p className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">
                  Physical & Tabletop
              ...
              <div className="bg-white border border-warm-gray-200 rounded-3xl p-6 hover:border-amber-500 transition-colors group text-center shadow-sm">
                <h3 className="font-serif text-3xl font-black text-amber-500 mb-1 group-hover:scale-105 transition-transform duration-300">
                  45+
                </h3>
                <p className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">
                  Cities Explored
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mb-16">
            <div className="flex-1 text-left">
              <span className="cross-marker mb-4 block text-rose-600 text-lg">
                ✦
              </span>
              ...
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-6 font-sans">
                I capture my journeys, global explorations, and cultural
                encounters across my video channels. Through cinematic travel
                vlogs and life diaries, I share the beauty of different
                destinations, local cuisines, and travel stories to inspire
                others to step out and explore the world.
              </p>
              <div className="editorial-divider w-16 h-px bg-warm-gray-300" />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-16">
            <div className="flex-1 text-left">
              ...
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-6 font-sans">
                Gaming is my ultimate creative sandbox and escape. I play and
                analyze both digital video games and physical tabletop board
                games. Whether strategizing routes in physical tabletop games or
                exploring lore-rich open-world RPGs on PC, gaming provides both
                entertainment and deep system design inspiration.
              </p>
              <div className="editorial-divider w-16 h-px bg-warm-gray-300" />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="flex-1 text-left">
              ...
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-6 font-sans">
                Hiking back-country trails and traveling to new environments
                provides the essential life balance needed to stay creative. I
                capture high-contrast travel photography along the way,
                cataloging natural frameworks, lighting patterns, and structural
                scales. Hover over photo frames to check captions.
              </p>
              <div className="editorial-divider w-16 h-px bg-warm-gray-300" />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-16">
            <div className="flex-1 text-left">
              ...
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-6 font-sans">
                I am proud to serve as an active media team member for the Full
                Gospel Pentecostal Church of God. Handling and operating video
                cameras, setting up equipment rigs, running lyrics
                presentations, and managing switcher consoles lets me combine my
                technological experience with community service. Supporting
                spiritual worship through live media is a passion that gives
                deep purpose and balance to my life.
              </p>
              <div className="editorial-divider w-16 h-px bg-warm-gray-300" />
            </div>
