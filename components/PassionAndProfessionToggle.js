  ...
  return (
    <>
      ...
      <div
        ...
        className={`sticky top-[64px] sm:top-[68px] z-40 w-full flex flex-col items-center justify-center transition-all duration-500 ease-out ${
          isSticky
      ...
      >
        ...
        <div
          className={`absolute pointer-events-none transition-all duration-700 blur-2xl rounded-full ${
            isSticky ? "w-48 h-12 opacity-40" : "w-72 h-20 opacity-70"
          } ${
        ...
        <div
          className={`flex flex-col items-center transition-all duration-500 ease-in-out overflow-hidden ${
            isSticky
        ...
        >
          <div className="flex items-center gap-2 mb-1.5">
            <span
              className={`inline-flex items-center gap-1.5 text-[10px] font-sans font-extrabold uppercase tracking-[0.25em] px-3.5 py-1 rounded-full border shadow-2xs transition-all duration-500 ${
                viewState === "profession"
        ...
        <div
          ...
          className={`relative flex items-center bg-white/70 backdrop-blur-2xl border border-white/90 ring-1 ring-black/5 transition-all duration-300 ease-out ${
            isSticky
        ...
        >
          ...
          <div
            className={`absolute rounded-full transition-all duration-300 ease-[cubic-bezier(0.34,1.45,0.64,1)] ${
              viewState === "profession"
          ...
          <button
            ...
            className={`relative z-10 flex-1 flex items-center justify-center gap-1.5 font-sans font-bold uppercase tracking-wider transition-all duration-300 rounded-full group ${
              isSticky ? "py-1.5 text-[10px]" : "py-2 text-[11px]"
            } ${
              viewState === "profession"
