    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle, rgba(198,40,40,0.05) 0%, rgba(198,40,40,0.01) 60%, transparent 100%)",
      ...
      <div
        className="absolute -top-20 -right-20 w-[500px] h-[500px] rounded-full pointer-events-none z-0"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-0 -left-20 w-[400px] h-[400px] rounded-full pointer-events-none z-0"
        style={{
          background:
            "radial-gradient(circle, rgba(198,40,40,0.05) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(250,248,245,0.6) 0%, transparent 60%)",
        }}
      />
