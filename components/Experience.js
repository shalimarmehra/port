  ...
  return (
    <>
      <section id="experience" className="py-5">
        <span className="ml-5 xl:ml-24 font-Mitr">.../Experience ...</span>
          ...
          <div className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost pl-5">
            <ul className="italic font-ost list-disc ml-3 ">
              <li>
                ...
                business delivering comprehensive services including web design,
          ...
          <div className="text-gray-700 mb-4 text-justify text-sm sm:text-base max-w-full font-ost pl-5">
            <ul className="italic font-ost list-disc ml-3">
              ...
              <li>
                ...
                future projects and client work, demonstrating resilience and a
